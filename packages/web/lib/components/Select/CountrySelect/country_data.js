...
exports.allCountryCodes = exports.allCountries = void 0;
...
var allCountryCodes = {};
exports.allCountryCodes = allCountryCodes;
var areaItems = [];
...
var allCountries = (_ref = []).concat.apply(
  _ref,
  _toConsumableArray(
    rawAllCountries.map(function (country) {
      ...
      if (countryItem.hasAreaCodes) {
        areaCodes.forEach(function (areaCode) {
          var areaItem = _objectSpread(
            _objectSpread({}, countryItem),
            {},
            {
              regions: regions,

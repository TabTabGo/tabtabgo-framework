...
var withValidation = function withValidation(Component) {
    ...
    _createClass(WithValidation, [
      {
        ...
        value: function render() {
          ...
          return /*#__PURE__*/ _react['default'].createElement(
            _Form.ValidationFormContext.Consumer,
            null,
            function (context) {
  ...
  WithValidation.displayName = 'withValidation('.concat(getDisplayName(Component), ')');
  (0, _hoistNonReactStatics['default'])(WithValidation, Component);
  return WithValidation;
};

...
// // // Button styles
// #############################
var getButtonBoxShadow = function getButtonBoxShadow(hexColor) {
  var rgb = (0, _utilities.hexToRgb)(hexColor);
  return '0 2px 2px 0 rgba('
    .concat(rgb.r, ', ')
    .concat(rgb.g, ', ')
    .concat(rgb.b, ', 0.14), 0 3px 1px -2px rgba(')
    .concat(rgb.r, ', ')
    .concat(rgb.g, ', ')
    .concat(rgb.b, ', 0.2), 0 1px 5px 0 rgba(')
    .concat(rgb.r, ', ')
    .concat(rgb.g, ', ')
    .concat(rgb.b, ', 0.12)');
};

var getButtonFocusBoxShadow = function getButtonFocusBoxShadow(hexColor) {
  var rgb = (0, _utilities.hexToRgb)(hexColor);
  return '0 14px 26px -12px rgba('
    .concat(rgb.r, ', ')
    .concat(rgb.g, ', ')
    .concat(rgb.b, ', 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(')
    .concat(rgb.r, ', ')
    .concat(rgb.g, ', ')
    .concat(rgb.b, ', 0.2)');
};

...
var customDropdownStyle = function customDropdownStyle(theme) {
  return {
    ...
    dropdownItem: _objectSpread(
      _objectSpread({}, _themeHelpers.defaultFont),
      {},
      {
        fontSize: '13px',
        padding: '10px 20px',
    ...
    primaryHover: {
      '&:hover': _objectSpread(
        ...
        (0, _themeHelpers.getPrimaryBoxShadow)(theme),
      ),
    },
    infoHover: {
      '&:hover': _objectSpread(
        ...
        (0, _themeHelpers.getInfoBoxShadow)(theme),
      ),
    },
    successHover: {
      '&:hover': _objectSpread(
        ...
        (0, _themeHelpers.getSuccessBoxShadow)(theme),
      ),
    },
    warningHover: {
      '&:hover': _objectSpread(
        ...
        (0, _themeHelpers.getWarningBoxShadow)(theme),
      ),
    },
    dangerHover: {
      '&:hover': _objectSpread(
        ...
        (0, _themeHelpers.getErrorBoxShadow)(theme),
      ),
    },
    dropdownDividerItem: {
      margin: '5px 0',

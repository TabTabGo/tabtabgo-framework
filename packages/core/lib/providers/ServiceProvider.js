...
var ServiceProvider = /*#__PURE__*/function () {
  ...
  _createClass(ServiceProvider, [{
    ...
    value: function newAjaxService() {
      ...
      return (_this$services$ajaxSe = this.services.ajaxService) === null || _this$services$ajaxSe === void 0 ? void 0 : _this$services$ajaxSe._new(controller, prefixUrl, this.dispatch, appSettings);
    }
  }, {
    key: "getFileService",
    ...
    value: function newFileService() {
      ...
      return (_this$services$fileSe = this.services.fileService) === null || _this$services$fileSe === void 0 ? void 0 : _this$services$fileSe._new(controller);
    ...
    value: function getNotificationService() {
      ...
      return (_this$services = this.services) === null || _this$services === void 0 ? void 0 : _this$services.notificationService;
    }
  }, {
    ...
    value: function newExportService() {
      ...
      return (_this$services$export = this.services.exportService) === null || _this$services$export === void 0 ? void 0 : _this$services$export._new(configuration);
    }
  }, {
    key: "setService",

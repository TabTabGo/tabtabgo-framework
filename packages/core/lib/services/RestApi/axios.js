...
var Axios = /*#__PURE__*/function (_BaseAjaxService) {
  ...
  function Axios(controller, prefixUrl, dispatch, appSettings) {
    ...
    _this.refreshToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var identityService;
    ...
    _this.currentAxios = _axios["default"].create({
      baseUrl: _Appsettings.AppSettings.baseApiUrl ? "".concat(_Appsettings.AppSettings.baseApiUrl, "/").concat(_this.prefixUrl) : "/",
    ...
    _this.currentAxios.interceptors.request.use( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(requestConfig) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 25:
                ...
                console.warn("Refresh token Failed. ", _context2.t0 === null || _context2.t0 === void 0 ? void 0 : _context2.t0.message, _context2.t0);
                addToken = false;
              ...
              case 35:
                ...
                requestConfig.headers[headerKey !== null && headerKey !== void 0 ? headerKey : "Authorization"] = "".concat(tokenType ? tokenType + ' ' : '').concat(token);
                _context2.next = 41;
                break;
    ...
    _this.currentAxios.interceptors.response.use(function (response) {
      return response;
    }, /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                ...
                if (!( // TODO move to setup
                error.response && (error.response.status === 401 || error.response.status === 403 && ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : (_error$response$data = _error$response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.messageCode) === "tokenIsExpired" || error.response.status === 400 && ((_error$response2 = error.response) === null || _error$response2 === void 0 ? void 0 : (_error$response2$data = _error$response2.data) === null || _error$response2$data === void 0 ? void 0 : _error$response2$data.messageCode) === "userNotFound") //&& !originalRequest._retry
                )) {
                  _context3.next = 12;
                  break;
                }
                ...
                return _context3.abrupt("return", self.refreshToken().then(function (res) {
                  //console.log('refreshToken', res)
                  if (res) {
                    // 2) Change Authorization header
                    return self.sessionManger.getToken().then(function (token) {
                      self.currentAxios.defaults.headers.common[headerKey !== null && headerKey !== void 0 ? headerKey : "Authorization"] = "".concat(tokenType ? tokenType + ' ' : '').concat(token); //axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorageService.getAccessToken();
                    ...
                    console.warn('failed to get token from refresh token;', error === null || error === void 0 ? void 0 : error.message, error);
                    self.resetPage();
                  }
                })["catch"](function (refreshError) {
                  console.warn('failed to get token from refresh token;', refreshError === null || refreshError === void 0 ? void 0 : refreshError.message, refreshError);
                  self.resetPage();
                }));
  ...
  _createClass(Axios, [{
    ...
    key: "Abort",
    value: function () {
      var _Abort = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var allRequests,
            _args4 = arguments;
    ...
    key: "restApi",
    value: function () {
      var _restApi = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
        var method,
            url,
            parameters,
            body,
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                responseType = _args5.length > 5 && _args5[5] !== undefined ? _args5[5] : "json";
                responseEncoding = _args5.length > 6 && _args5[6] !== undefined ? _args5[6] : "utf8";
                actionDescription = _args5.length > 7 && _args5[7] !== undefined ? _args5[7] : "";
                notifyOnError = _args5.length > 8 && _args5[8] !== undefined ? _args5[8] : false;
              ...
              case 29:
                ...
                if (_context5.t0 !== null && _context5.t0 !== void 0 && (_errorResponse$respon = _context5.t0.response) !== null && _errorResponse$respon !== void 0 && _errorResponse$respon.data) {
                  error = _context5.t0.response.data;
                }

                if (!((_error = error) !== null && _error !== void 0 && _error.status) && _context5.t0 !== null && _context5.t0 !== void 0 && (_errorResponse$respon2 = _context5.t0.response) !== null && _errorResponse$respon2 !== void 0 && _errorResponse$respon2.status) {

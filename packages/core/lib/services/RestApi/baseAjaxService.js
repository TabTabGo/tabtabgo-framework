...
var BaseAjaxService = /*#__PURE__*/function () {
  function BaseAjaxService(controller, prefixUrl, dispatch, appSettings) {
    ...
    this.parseUrl = function () {
      ...
      if (url.startsWith("//")) {
        ...
        if (url.startsWith("?")) finialUrl = "".concat(_this.controller).concat(url);else finialUrl = "".concat(_this.controller, "/").concat(url);
      }

      if (concatBaseUrl) {
        var _AppSettings$baseApiU;

        finialUrl = "".concat((_AppSettings$baseApiU = _Appsettings.AppSettings.baseApiUrl) !== null && _AppSettings$baseApiU !== void 0 ? _AppSettings$baseApiU : "", "/").concat(_this.prefixUrl).concat(finialUrl);
      }
    ...
    this.appSettings = Object.assign({}, _Appsettings.AppSettings, appSettings !== null && appSettings !== void 0 ? appSettings : {});
  ...
  _createClass(BaseAjaxService, [{
    ...
    key: "Abort",
    value: function () {
      var _Abort = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(allRequests) {
    ...
    value: function Get(_ref) {
      ...
      return this.restApi("GET", url, parameters, undefined, header, responseType, responseEncoding, actionDescription, notifyOnError);
    }
  }, {
    key: "Put",
    value: function Put(_ref2) {
      ...
      return this.restApi("PUT", url, parameters, body, header, responseType, responseEncoding, actionDescription, notifyOnError);
    }
  }, {
    key: "Patch",
    value: function Patch(_ref3) {
      ...
      return this.restApi("PATCH", url, parameters, body, header, responseType, responseEncoding, actionDescription, notifyOnError);
    }
  }, {
    key: "Post",
    value: function Post(_ref4) {
      ...
      return this.restApi("POST", url, parameters, body, header, responseType, responseEncoding, actionDescription, notifyOnError, isFormData);
    }
  }, {
    key: "Delete",
    value: function Delete(_ref5) {
      ...
      return this.restApi("DELETE", url, parameters, body, header, responseType, responseEncoding, actionDescription, notifyOnError);
    }
  }, {
    key: "restApi",
    value: function () {
      var _restApi = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(method, url, parameters, body, header, responseType, responseEncoding, actionDescription, notifyOnError, isFormData) {

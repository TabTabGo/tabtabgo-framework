...
var RestApi = /*#__PURE__*/function (_BaseAjaxService) {
  ...
  function RestApi(controller, prefixUrl, dispatch) {
    ...
    _this.internalApiCall = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(request, actionDescription, notifyOnError) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _context.next = 10;
                return _this.validateResponseStatus(responseObj, actionDescription || "", notifyOnError || false, request);
    ...
    _this.parseResponse = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(response) {
        ...
        var contentType, data, _response$headers$get, contentTypeParts, mimeType, type, subType, text;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!(response.headers && (_response$headers = response.headers) !== null && _response$headers !== void 0 && _response$headers.has("Content-Type"))) {
                  _context2.next = 56;
                  break;
                }

                contentTypeParts = (_response$headers$get = response.headers.get("Content-Type")) === null || _response$headers$get === void 0 ? void 0 : _response$headers$get.split(";");
                ...
                _context2.t0 = type;
                _context2.next = _context2.t0 === "text" ? 9 : _context2.t0 === "image" ? 20 : _context2.t0 === "audio" ? 20 : _context2.t0 === "video" ? 20 : _context2.t0 === "application" ? 27 : _context2.t0 === "multipart" ? 45 : 50;
                break;

              case 9:
                _context2.t1 = subType;
                _context2.next = _context2.t1 === "plain" ? 12 : _context2.t1 === "css" ? 17 : _context2.t1 === "html" ? 17 : _context2.t1 === "markdown" ? 17 : 17;
                break;
              ...
              case 17:
                console.log("Error: ".concat(type, "/").concat(subType, " handle not supported yet"));
                return _context2.abrupt("break", 19);
              ...
              case 27:
                ...
                _context2.next = _context2.t4 === "octet-stream" ? 30 : _context2.t4 === "pdf" ? 30 : _context2.t4 === "json" ? 37 : _context2.t4 === "javascript" ? 42 : _context2.t4 === "ecmascript" ? 42 : 42;
                break;
    ...
    _this.validateStatus1xx = /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(parsedResponse, actionDescription, notifyOnError, request) {
    ...
    _this.validateStatus2xx = /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(response, actionDescription, notifyOnError, request) {
    ...
    _this.validateStatus3xx = /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(response, actionDescription, notifyOnError, request) {
    ...
    _this.validateStatus4xx = /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(response, exception, actionDescription, notifyOnError, request) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                throw new _TTGError.TTGError("You are not authorized ".concat(actionDescription ? "to " + actionDescription : "", "."), "REST_API_ERROR_NOT_AUTHORIZED");

              case 5:
                if (!(response.status === 401 && (exception === null || exception === void 0 ? void 0 : exception.code) === "invalid_token")) {
                  _context6.next = 23;
                  break;
                }
              ...
              case 23:
                if (response.status === 400) {} else if (response.status === 401 && (exception === null || exception === void 0 ? void 0 : exception.code) !== "LOGIN_INVALID") {
                  //this.resetPage();
                  isErrorHandled = true;
                }
    ...
    _this.validateStatus5xx = /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(response, exception, actionDescription, notifyOnError, request) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                throw new _TTGError.TTGError(exception.message, "500", _objectSpread(_objectSpread({}, exception), {}, {
                  isErrorHandled: false
                }));
    ...
    _this.validateCustomStatus = /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(response, exception, actionDescription, notifyOnError, request) {
    ...
    _this.validateResponseStatus = /*#__PURE__*/function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(response, actionDescription, notifyOnError, request) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                _context9.next = 4;
                return _this.validateStatus1xx(response, actionDescription, notifyOnError, request);
              ...
              case 5:
                ...
                _context9.next = 8;
                return _this.validateStatus2xx(response, actionDescription, notifyOnError, request);
              ...
              case 9:
                ...
                _context9.next = 18;
                return _this.validateStatus4xx(response, exception, actionDescription, notifyOnError, request);
              ...
              case 23:
                _context9.next = 25;
                return _this.validateCustomStatus(response, exception, actionDescription, notifyOnError, request);
    ...
    _this.refreshToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 8:
              ...
              _context10.next = 11;
              return _this.sessionManger.setToken(token, token.type || "Bearer", token.expiredAt);
  ...
  _createClass(RestApi, [{
    ...
    key: "restApi",
    value: function () {
      var _restApi = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(method, url, parameters, body, header, responseType, responseEncoding, actionDescription, notifyOnError, isFormData) {
        var requestUrl, headerProps, token, tokenType, isTokenExpired, addToken, customHeader, requestInit, request;
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 44:
                this.resetPage();
                throw new _TTGError.TTGError("Your session is expired. Please Login Again.", "REST_API_ERROR_SESSION_EXPIRED");

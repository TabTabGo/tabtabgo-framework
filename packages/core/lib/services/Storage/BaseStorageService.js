...
var BaseStorageService = function BaseStorageService() {
  ...
  this.setToken = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(accessToken, tokenType, tokenExpired) {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all([_this.setAccessToken(accessToken), _this.setAccessToken(tokenType), _this.setTokenExpire(tokenExpired || -1)]);
  ...
  this.getUser = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var user;
  ...
  this.isTokenExpired = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
  ...
  this.resetToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var resetTasks;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            resetTasks = [_this.reset(_this.token_type), _this.reset(_this.token_expired), _this.reset(_this.user_info), _this.reset(_this.refresh_token)];
            _context4.next = 3;

...
var EntityAction = /*#__PURE__*/ (function () {
  ...
  function EntityAction(
    ...
    this.getEntity = /*#__PURE__*/ (function () {
      var _ref = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee(id, onLoaded, expand) {
          var entity;
                ...
                switch ((_context.prev = _context.next)) {
                  ...
                  case 13:
                    ...
                    _this.error(
                      ...
                      'GET_ENTITY',
                      _context.t0,
                      'Failed Loading '.concat(_this.nameSingularText),
                    );
                  ...
                  return _context2.abrupt(
                    ...
                    _this.currentService
                      ...
                      ['catch'](function (error) {
                        ...
                        _this.error(
                          _this.dispatch,
                          _this.actionTypes.search,
                          error,
                          'Failed in search ' + _this.namePluralText,
                        );
    ...
    this.saveEntity = /*#__PURE__*/ (function () {
      var _ref3 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(entity, options) {
    ...
    this.updateEntity = /*#__PURE__*/ (function () {
      var _ref4 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(entity, options) {
              ...
              while (1) {
                switch ((_context4.prev = _context4.next)) {
                  case 0:
                    ...
                    _context4.prev = 1;
                    _context4.next = 4;
                    return _this.currentService.updateEntity(
                      entity,
                  ...
                  case 4:
                    ...
                    message =
                      options && options.successMessage
                        ...
                        : ''
                            .concat(_this.nameSingularText, ' ')
                            .concat(_this.getDisplayValue(entity), ' updated successfully.');
                    _context4.next = 8;
                  ...
                  case 14:
                    ...
                    errorTitle = 'Updating '
                      .concat(_this.nameSingularText, ' ')
                      .concat(_this.getDisplayValue(entity), ' failed');

                    if (_context4.t0 && !_context4.t0.message) {
                      _context4.t0.message = ''
                        .concat(errorTitle, '. ')
                        .concat(_context4.t0.message);
                    }
    ...
    this.createEntity = /*#__PURE__*/ (function () {
      var _ref5 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(entity, options) {
              ...
              while (1) {
                switch ((_context5.prev = _context5.next)) {
                  case 0:
                    ...
                    _context5.prev = 1;
                    _context5.next = 4;
                    return _this.currentService.createEntity(
                      entity,
                      options ? options.properties : null,
                    );
                  ...
                  case 7:
                    ...
                    message =
                      options && options.successMessage
                        ...
                        : ''
                            .concat(_this.nameSingularText, ' ')
                            .concat(_this.getDisplayValue(entity), ' added successfully.');
    ...
    this.deleteEntity = /*#__PURE__*/ (function () {
      var _ref7 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee7(entity, options) {
              ...
              while (1) {
                switch ((_context7.prev = _context7.next)) {
                  ...
                  case 4:
                    ...
                    _this.success(
                      _this.dispatch,
                      _this.actionTypes['delete'],
                      ''
                        .concat(_this.nameSingularText, ' ')
                        .concat(_this.getDisplayValue(entity), ' deleted successfully'),
                    );
    ...
    this.deleteEntities = /*#__PURE__*/ (function () {
      var _ref8 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee8(entities, options) {
          var result, errorTitle;
          return regeneratorRuntime.wrap(
                ...
                switch ((_context8.prev = _context8.next)) {
                  ...
                  case 4:
                    ...
                    _this.success(
                      _this.dispatch,
                      _this.actionTypes['delete'],
                      'Selected '.concat(_this.nameSingularText, ' deleted successfully'),
                    );
              ...
              while (1) {
                switch ((_context9.prev = _context9.next)) {
                  case 0:
                    ...
                    _context9.prev = 1;
                    _context9.next = 4;
                    return _this.currentService.entitiesActivation(
                      entities,
                      status,
                      activationParameter,
                    );
    ...
    this.exportEntities = /*#__PURE__*/ _asyncToGenerator(
            ...
            switch ((_context10.prev = _context10.next)) {
              ...
              case 7:
                return _context10.abrupt(
                  'return',
                  _this.exportCsv(entities, searchParams, exportConfig),
                );

              case 8:
                return _context10.abrupt(
                  'return',
                  _this.exportPdf(entities, searchParams, exportConfig),
                );

              case 9:
                return _context10.abrupt(
                  'return',
                  _this.exportExcel(entities, searchParams, exportConfig),
                );

              case 10:
                return _context10.abrupt(
                  'return',
                  _this.exportCustomized(entities, searchParams, exportConfig),
                );
              ...
              while (1) {
                switch ((_context11.prev = _context11.next)) {
                  ...
                  case 7:
                    ...
                    _this.exportsService.downloadFile(
                      window.URL.createObjectURL(result.blob),
                      result.filename ||
                        _this.nameSingularText +
                          '_' +
                  ...
                  case 12:
                    ...
                    errorTitle = 'Export to Csv for selected '.concat(
                      _this.nameSingularText,
                      ' failed',
                    );
                    ...
                    _this.error(
                      _this.dispatch,
                      _this.actionTypes.exportingCsv,
                      _context11.t0,
                      errorTitle,
                    );
    ...
    this.success = function (dispatch, action, message) {
      ...
      if (message) {
        _this.notifySuccess(
          typeof message === 'string' ? message : 'Action completed successfully',
        );
      }
    };
    ...
    this.destroy = function () {
      ...
      (_this$currentService = _this.currentService) === null || _this$currentService === void 0
        ? void 0
        : _this$currentService.destroy();
      (_this$exportsService = _this.exportsService) === null || _this$exportsService === void 0
        ? void 0
        : _this$exportsService.destroy();
    };
    ...
    this.exportsService = exportsService
      ? exportsService
      : _ServiceProvider.currentServiceProvider.getExportService();
    this.actionTypes = _actionTypes
      ? _actionTypes
      : (0, _ActionTypes['default'])(this.namePlural, this.nameSingular);
  ...
  _createClass(EntityAction, [
    ...
    },
    {
      ...
      value: (function () {
        var _loadEntityExtra = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee16(id, dispatch) {
    ...
    },
    {
      ...
      value: (function () {
        var _onAddSuccessfully = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee17(entity, dispatch) {
    ...
    },
    {
      ...
      value: (function () {
        var _onUpdateSuccessfully = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee18(entity, dispatch) {
    ...
    },
    {
      ...
      value: function notifySuccess(message, options) {
        ...
        (_this$notificationSer = this.notificationService) === null ||
        _this$notificationSer === void 0
          ? void 0
          : _this$notificationSer.notifySuccess(message, options);
      },
    },
    {
      key: 'notifyError',
      value: function notifyError(message, options) {
        ...
        (_this$notificationSer2 = this.notificationService) === null ||
        _this$notificationSer2 === void 0
          ? void 0
          : _this$notificationSer2.notifyError(message, options);
      },
    },
  ]);

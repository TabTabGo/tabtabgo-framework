...
var EntityActionTypes = function EntityActionTypes() {
  ...
  return {
    ...
    flag: function flag(action) {
      return action ? "".concat(uppercaseModule, "/FLAG/").concat(action.toUpperCase()) : "".concat(uppercaseModule, "/FLAG/UPDATE");
    },
    error: function error(action) {
      return action ? "".concat(uppercaseModule, "/ERROR/").concat(action.toUpperCase()) : "".concat(uppercaseModule, "/FLAG/ERROR");
    },

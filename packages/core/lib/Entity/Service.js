...
var EntityService = /*#__PURE__*/ (function () {
  ...
  function EntityService(
    ...
    this.restApi = _ServiceProvider.currentServiceProvider.newAjaxService(
  ...
  _createClass(EntityService, [
    ...
    },
    {
      ...
      value: (function () {
        var _getEntity = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee(id, expand) {
                  ...
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      return this.restApi.Get({
                        ...
                        actionDescription: 'Getting '
                          .concat(this.nameSingularText, ' id:')
                          .concat(id),
                      });
    ...
    },
    {
      key: 'internalSearch',
      value: (function () {
        var _internalSearch = _asyncToGenerator(
    ...
    },
    {
      ...
      value: function getPatchEntityParameters(id, entityChanges) {
        return {
          ...
          body: entityChanges,
          actionDescription: 'Save changes for '
            .concat(this.nameSingularText, ' ')
            .concat(this.getDisplayValue(entityChanges)),
        };
    ...
    },
    {
      ...
      value: (function () {
        var _saveChanges = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(id, entity, changes, original) {
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    case 0:
                      ...
                      changesBeforeSend = changes
                        ? this.populateChangesBeforeSend(changes)
                        : changes;
                    ...
                    case 4:
                      ...
                      return _context4.abrupt(
                        ...
                        this.postUpdateEntity(
                          this.populateChangesAfterReceive(entity, responseData),
                        ),
                      );
    ...
    },
    {
      ...
      value: (function () {
        var _saveEntity = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(entity, props) {
            return regeneratorRuntime.wrap(
      ...
      value: function getUpdateEntityParameters(entity, props) {
        ...
        var requestParameters = {
          ...
          actionDescription: 'Update '
            .concat(this.nameSingularText, ' ')
            .concat(this.getDisplayValue(entity)),
        };

        if (props && props.parameters) {
          requestParameters.parameters = Object.assign(
    ...
    },
    {
      key: 'updateEntity',
      value: (function () {
        var _updateEntity = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee6(entity, props) {
                  ...
                  switch ((_context6.prev = _context6.next)) {
                    ...
                    case 3:
                      ...
                      return _context6.abrupt(
                        'return',
                        this.postUpdateEntity(this.populateEntityAfterReceive(entity, response)),
                      );
    ...
    },
    {
      ...
      value: function getCreateEntityParameters(entity, props) {
        ...
        var requestParameters = {
          ...
          actionDescription: 'Adding '
            .concat(this.nameSingularText, ' ')
            .concat(this.getDisplayValue(populatedEntity)),
        };
    ...
    },
    {
      key: 'createEntity',
      value: (function () {
        var _createEntity = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee7(entity, props) {
                  ...
                  switch ((_context7.prev = _context7.next)) {
                    ...
                    case 3:
                      ...
                      return _context7.abrupt(
                        'return',
                        this.postCreateEntity(this.populateEntityAfterReceive(entity, data)),
                      );
    ...
    },
    {
      key: 'deleteEntity',
      value: (function () {
        var _deleteEntity = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee8(entity) {
            return regeneratorRuntime.wrap(
    ...
    },
    {
      key: 'deleteEntities',
      value: (function () {
        var _deleteEntities = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee9(entities) {
            var _this = this;
                  ...
                  switch ((_context9.prev = _context9.next)) {
                    case 0:
                      ...
                      return this.restApi.Delete({
                        ...
                        actionDescription: 'Delete '
                          .concat(entities.length, ' ')
                          .concat(this.namePluralText),
                      });
    ...
    },
    {
      ...
      value: (function () {
        var _entitiesActivation = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee10(entities) {
            var _this2 = this,
              _parameters;
    ...
    },
    {
      key: 'exportCSV',
      value: (function () {
        var _exportCSV = _asyncToGenerator(
                  ...
                  switch ((_context11.prev = _context11.next)) {
                    case 0:
                      return _context11.abrupt(
                        'return',
                        this.internalExport('csv', entities, searchParams, exportConfig),
                      );
    ...
    },
    {
      key: 'internalExport',
      value: (function () {
        var _internalExport = _asyncToGenerator(

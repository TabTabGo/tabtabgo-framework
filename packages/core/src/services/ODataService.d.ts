...
export declare class ODataFilterService {
    ...
    getOperator: (operator: any) => "eq" | "lt" | "gt" | "ge" | "le" | "ne" | "endswith" | "startswith" | "contains";
    createPredicatesFromSearchFilters: (search?: any, filters?: any[] | undefined) => QueryPredicate[];
    getODataFilter: (search?: any, filters?: any[] | undefined) => string;

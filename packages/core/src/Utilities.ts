...
export const isEqual = (value: any, other: any) => {
  ...
  // Compare two items
  var compare = (item1: any, item2: any) => {
    // Get the object type
...
export const arrayUnique = (array: Array<any>, equalCompare?: (a: any, b: any) => boolean) => {
  var a = array.concat();
  if (!equalCompare) equalCompare = (a, b) => isEqual(a, b);
...
export const getPropertyValue = (entity: any, propertyPath: string) => {
...
type GetDisplayField = (entity: any) => string;

export const getDisplayValue = (entity: any, displayField: string | GetDisplayField) => {
  if (displayField) {
...
export const getPersonInitials = (entity: any) => {
  if (entity && entity.person && entity.person.firstName && entity.person.lastName) {
...
export function isEmpty(value?: any) {
  if (_.isDate(value) && value) return false;
  if (typeof value === 'object' && _.isEmpty(value)) return true;
  if (value === null || value === undefined || value === '') return true;
  return false;
}

export function populatePageList<TEntity, TOutput>(
  result: PagingList<TEntity>,
  map: (item: TEntity, index?: number, array?: Array<TEntity>) => Array<TOutput>,
) {
...
export const getFriendlyString = (word: string) => {
...
export const getUniqueId = (index: number) => {
  let date = new Date();
...
export const getJsonPatchDocument = (originalValue: any, newValue: any, path: string) => {

...
export declare const arrayUnique: (array: Array<any>, equalCompare?: (a: any, b: any) => boolean) => any[];
...
export declare function getToken(hash: string): any;
export declare function getSearchParams(query: string): qs.ParsedQs;

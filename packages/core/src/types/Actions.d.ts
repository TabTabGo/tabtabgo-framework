...
export interface IActions<T> {
    ...
    saveEntityChanges: (id: any, entity: T, changes: Array<JsonPatch>, original: T, options?: ActionOptions) => Promise<any>;
    ...
    exportEntities: (exportType: string, entities: Array<T>, status?: boolean, activationParameter?: string) => Promise<any>;
}
